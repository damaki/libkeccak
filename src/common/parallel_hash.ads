...
--     --  ParallelHash instantiations
   ...
   package ParallelHash128 is new Keccak.Generic_Parallel_Hash
     (CV_Size_Bytes     => 256 / 8,
      ...
      CSHAKE_Parallel_2 => CSHAKE128_P2,
      CSHAKE_Parallel_4 => CSHAKE128_P4,
      CSHAKE_Parallel_8 => CSHAKE128_P8);

   package ParallelHash256 is new Keccak.Generic_Parallel_Hash
     (CV_Size_Bytes     => 512 / 8,
      CSHAKE_Serial     => CSHAKE.CSHAKE256,
      CSHAKE_Parallel_2 => CSHAKE256_P2,
      CSHAKE_Parallel_4 => CSHAKE256_P4,
      CSHAKE_Parallel_8 => CSHAKE256_P8);
